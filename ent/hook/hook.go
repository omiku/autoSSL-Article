...
// The CertificateDeploymentFunc type is an adapter to allow the use of ordinary
// function as CertificateDeployment mutator.
type CertificateDeploymentFunc func(context.Context, *ent.CertificateDeploymentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CertificateDeploymentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CertificateDeploymentMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CertificateDeploymentMutation", m)
}
...
// The GlobalNotificationConfigFunc type is an adapter to allow the use of ordinary
// function as GlobalNotificationConfig mutator.
type GlobalNotificationConfigFunc func(context.Context, *ent.GlobalNotificationConfigMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GlobalNotificationConfigFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GlobalNotificationConfigMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GlobalNotificationConfigMutation", m)
}
...
func (f NotificationConfigFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.NotificationConfigMutation); ok {
		return f(ctx, mv)
	}
...
// The ServerGroupFunc type is an adapter to allow the use of ordinary
// function as ServerGroup mutator.
type ServerGroupFunc func(context.Context, *ent.ServerGroupMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ServerGroupFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ServerGroupMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ServerGroupMutation", m)
}

// The ServerGroupMemberFunc type is an adapter to allow the use of ordinary
// function as ServerGroupMember mutator.
type ServerGroupMemberFunc func(context.Context, *ent.ServerGroupMemberMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ServerGroupMemberFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ServerGroupMemberMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ServerGroupMemberMutation", m)
}
...
type WorkflowStepFunc func(context.Context, *ent.WorkflowStepMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WorkflowStepFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WorkflowStepMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WorkflowStepMutation", m)
}
