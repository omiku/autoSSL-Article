...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			certificatedeployment.Table:    certificatedeployment.ValidColumn,
			dnsprovider.Table:              dnsprovider.ValidColumn,
			globalnotificationconfig.Table: globalnotificationconfig.ValidColumn,
			...
			servergroup.Table:              servergroup.ValidColumn,
			servergroupmember.Table:        servergroupmember.ValidColumn,
